...
if( isset($_POST['submit']) ) {
  ...
  //trim() shrink any space of String
  //return to orginal from back slashes
...
<?php } else {
  if( !empty($errors) ) {
    foreach( $errors as $error ) { ?>
      <p>Error: <em><b><?php print $error; ?></b></em></p>
    <?php }
  }
} // end if-else
?>
...
<p><label for="message">Message: *</label> <textarea name="message" id="message" cols="20" rows="10"><?php print $fields['message']; ?></textarea></p>
