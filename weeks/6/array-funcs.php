...
/*
 * Dees an eleemtn with a specific key exist?
 */
if (isset($array[0])) {
...
if(!isset($array['string-key'])){
    print 'Index string-key doex not exist in $array<br />';
}


/*
 * remove/delete an eleement at a spcified offset/index
 */
 ...
 */
if (in_array(4, $array)) {
    print 'The value 4 does exist within out array' . '<br />';
}
else {
...
if (in_array(5, $array)) {
    print 'The value 5 does exist within out array' . '<br />';
}
else {
...
if( false === $pos) { //if is false, not found
